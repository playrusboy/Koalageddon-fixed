...
constexpr auto origin_entitlements_url = "https://raw.githubusercontent.com/DumbCodeGenerator/public-entitlements/main/origin/v1/entitlements.json";
constexpr auto steamclient_patterns_url = "https://raw.githubusercontent.com/DumbCodeGenerator/public-entitlements/main/koalageddon/v1/steamclient-patterns.json";
constexpr auto latest_release_url_api = "https://api.github.com/repos/DumbCodeGenerator/Koalageddon-fixed/releases/latest";
constexpr auto latest_release_url = L"https://github.com/DumbCodeGenerator/Koalageddon-fixed/releases/latest";
constexpr auto latest_support_forum_topic = L"https://cs.rin.ru/forum/viewtopic.php?p=2333491#p2333491";

// Registry & paths
constexpr auto KOALAGEDDON_KEY = R"(SOFTWARE\DumbCodeGenerator\Koalageddon)";
constexpr auto WORKING_DIR = "WORKING_DIR";
constexpr auto INSTALL_DIR = "INSTALL_DIR";
constexpr auto CONFIG_NAME = "Config.jsonc";
constexpr auto ACIDICOALA = "DumbCodeGenerator";
